...
{
    internal class RotationChange : Vector3ValueChange<AuggioObjectTracker>
    {
      
        internal RotationChange(string experienceId, string objectId, AuggioObjectTracker sceneComponent, string objectName, SerializedVector3 oldValue, SerializedVector3 newValue) : base(experienceId, objectId, sceneComponent, objectName, oldValue, newValue)
        {
        }

        internal override string UIStringName()
        {
            return "Object Rotation changed";
        }
        ...
        protected override AuggioObjectTracker DiscardChange(AuggioObjectTracker tracker, Scene scene, Experience experience, AuggioObject oldData)
        {
            ...
            {
                string error = "Cannot discard change because old data are missing anchor which the old value is relative to.";
            ...
            tracker.transform.rotation = RelativePositionCalculator.ObjectRotationRelativeToAnchor(relativeToAnchor, oldData);
            return tracker;
        }
