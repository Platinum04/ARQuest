...
{
    internal class PlaceholderRotationChange : Vector3ValueChange<AuggioObjectPlaceholderModel>
    {
        private string _placeholderId;
        
        internal PlaceholderRotationChange(string experienceId, string objectId,  string placeholderId, AuggioObjectPlaceholderModel sceneComponent, string objectName, SerializedVector3 oldValue, SerializedVector3 newValue) : base(experienceId, objectId, sceneComponent, objectName, oldValue, newValue)
        {
        ...
        protected override AuggioObjectPlaceholderModel DiscardChange(AuggioObjectPlaceholderModel model, Scene scene, Experience experience, AuggioObject oldData)
        {
            ...
            model.transform.localRotation = Quaternion.Euler(auggioObjectPlaceholder.Rotation.Deserialize());
            return model;
        }
        ...
        internal override void ApplyToExperience(Experience cachedExperience)
        {
            ...
            auggioObjectPlaceholder.Rotation = newValue;
        }
    }
}
#endif
